                ...
                <div class="grid lg:grid-cols-2 gap-x-6 gap-y-3 px-12  justify-items-center sm:grid-cols-1 ">
                    <div class="flex flex-col space-y-1 col-span-2 w-full">
                        <div class="flex justify-between">
                          <label for="eid"  class="labels">{{ __('time.time') }} :</label>
                          @error('time') <span class="danger ">{{ $message }}</span> @enderror  
                        </div>
                        <input wire:model.defer='time' class="inputs w-full col-span-2 @error('time') reds @enderror" type="text"   required  />       
                    </div>
                </div>
