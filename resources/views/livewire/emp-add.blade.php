                ...
                <div class="grid lg:grid-cols-2 gap-x-6 gap-y-3 px-12  justify-items-center sm:grid-cols-1 ">
                    <div class="flex flex-col space-y-1">
                        <div class="flex justify-between">
                          <label for="eid"  class="labels">{{ __('emp.noms') }}:</label>
                      ...
                      <div class="flex flex-col space-y-1">
                          <div class="flex justify-between">
                            <label   class="labels">{{ __('emp.nomsf') }}:</label>
                      ...
                      <div class="flex flex-col space-y-1 col-span-2 w-full">
                        <div class="flex justify-between">
                          <label   class="labels">{{ __('emp.pos') }}:</label>
                          @error('post') <span class="danger">{{ $message }}</span> @enderror  
                        </div>
                        <input wire:model.defer='post' class="w-full inputs @error('post') reds @enderror" type="text" required  />
                    </div>
  
                    <div  class="flex flex-col space-y-1">
                      <div class="flex justify-between">
                        <label for="eid"  class="labels">{{ __('emp.tel') }}:</label>
                  ...
                  <div class="flex flex-col space-y-1">
                      <div class="flex justify-between">
                        <label   class="labels">{{ __('emp.wh') }}:</label>
                    ...
                    <div class="flex flex-col space-y-1">
                        <div class="flex justify-between">
                          <label   class="labels">{{ __('emp.nni') }}:</label>
                    ...
                    <div class="flex flex-col space-y-1">
                        <div class="flex justify-between">
                          <label   class="labels">{{ __('emp.sal') }}:</label>
                          @error('ms') <span class="danger">{{ $message }}</span> @enderror  
                        </div>
                        <input wire:model.defer='ms' class="inputs @error('ms') reds @enderror" type="number" required  />
                    </div>
                </div>
