                    ...
                    <tr class="h-10 w-full py-2">
                        <td class="px-2 py-2  flex ">
                            ...
                            <div class=" flex space-x-2 items-center">
                                <label for="mat{{ $index }}"  class="flex items-center w-64">
                                ...
                                <input   wire:model.defer='note.{{ $index }}' class="inputs w-full  h-8 font-mono  @error('titre') reds @enderror" type="text"   required  />  
