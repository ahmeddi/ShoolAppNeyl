<div>
    <x-dialog-modal wire:model='visible' >
        <x-slot name='title'>
         ...
         <x-slot name='content'>
            <div x-data="{ montant: '', intret: 0, select: ''}" class="flex flex-col space-y-4 ">
                ...
                <div class="grid lg:grid-cols-2 gap-x-6 gap-y-3 px-12  justify-items-center sm:grid-cols-1 ">
                    <div class="flex flex-col space-y-1 w-full">
                        ...
                        <input dir="ltr" x-model='montant' x-mask:dynamic="$money($input, '.', ' ')" wire:model='montant' class="inputs w-full @error('montant') reds @enderror" type="text"   required  />
                    </div>
