              ...
              <div class="grid lg:grid-cols-2 gap-x-6 gap-y-3 px-12  justify-items-center sm:grid-cols-1 ">
                  <div class="flex flex-col space-y-1 w-full">
                      <div class="flex justify-between">
                        <label   class="labels">{{ __('notes.classe') }}:</label>
                  ...
                  <div class="flex flex-col space-y-1 w-full">
                    <div class="flex justify-between">
                      <label for="eid"  class="labels">{{ __('notes.nb') }}:</label>
                      @error('nb') <span class="danger ">{{ $message }}</span> @enderror  
                    </div>
                    <input wire:model.defer='nb' class="inputs w-full col-span-2 @error('nb') reds @enderror" type="number"   required  />       
                  </div>
                  ...
                  <div class="flex flex-col space-y-1 w-full">
                      ...
                      <input wire:model.defer='pos' class="inputs w-full col-span-2 @error('pos') reds @enderror" type="text"   required  />               
                    </div>
                    <div class="flex flex-col space-y-1 w-full">
                      <div class="flex justify-between">
