<div class="w-full h-full px-2 ">
    ...
    <div class=" w-full relative overflow-x-auto">
        <table class="w-full table-auto divide-y divide-gray-200 dark:divide-gray-600 rounded-md">
                ...
                <tr @class(['h-4','w-full','text-center','bg-red-500/20' => $dette->list, 'dark:bg-red-900/30' => $dette->list])  >
                    ...
                    <td dir="ltr" class="px-6 py-3 whitespace-nowrap ">
                        <div class="text-sm font-semibold rllt text-gray-900 dark:text-gray-200">
                            @if (($dette->type))
                                <span class="inline-flex items-center justify-center rounded-xl bg-red-100 dark:bg-red-900/40 dark:text-red-200 px-2.5 py-0.5 text-red-700">
                                    <p class="whitespace-nowrap text-sm font-semibold">
                                        {{ __('ent.pret') }} 
                                    </p>
                                </span>
                            @else
                                <span class="inline-flex items-center justify-center rounded-xl bg-teal-200 dark:bg-teal-900/60 dark:text-teal-200 px-2.5 py-0.5 text-teal-700">
                                    <p class="whitespace-nowrap text-sm font-semibold">
                                        {{ __('ent.free') }}
                                    </p>
                                </span>
