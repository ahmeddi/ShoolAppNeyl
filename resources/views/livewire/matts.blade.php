<div class="w-full h-full px-2  ">
    <div class= "flex justify-between mb-4">
        @can('dir')
            <button wire:click="$dispatch('mattadd')" class='focus:outline-none px-4 py-2 dark:text-gray-900 dark:bg-gray-100 text-white rounded-md hover:outline-none bg-teal-600 hover:bg-teal-800' >
                {{ __('mats.add') }}
            </button>
        @endcan
                ...
                @foreach ($Matts as $Matt)
                    <tr class="h-5 odd:bg-white even:bg-gray-50 dark:odd:bg-gray-800 dark:even:bg-gray-800/70">
                        ...
                        <td class="flex space-x-2 py-2 h-full items-center">
                            @can('dir')
                                <div class="mx-4">
                                    <button  wire:click="$dispatch('mattedit',{ id: {{ $Matt->id }} })"  >
                                ...
                                <div>
                                    ...
                                    <button wire:click="$dispatch('mattdel',{ id: {{ $Matt->id }} })"  class=" stroke-red-600">
    ...
    {{-- <div class="mt-2"> {{ $Matts->links() }}</div> --}}
