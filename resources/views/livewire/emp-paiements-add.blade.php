                ...
                <div class="grid lg:grid-cols-2 gap-x-6 gap-y-3 px-12  justify-items-center">
                     ...
                     <div class="col-span-2 w-full flex flex-col space-y-2">
                        <div class="flex justify-between ">
                            ...
                            @error('ids') <span class="danger">{{ $message }}</span> @enderror  
                        </div>
                        <select   wire:model.defer="motif"   class="inputs w-full @error('motif') reds @enderror">
                          <option value="">-----</option>
                          <option value="1"> {{ __('compt.sal') }} </option>
                          <option value="2"> {{ __('compt.debt') }} </option>
                          <option value="3"> {{ __('compt.bonis') }} </option>
                        </select>     
