<div >
    ...
    <table class="w-full divide-y divide-gray-200 dark:divide-gray-600 rounded-t-xl overflow-hidden">
        ...
        <tr >
            ...
            <th dir="ltr" scope="col" class="px-6 py-3 text-right  text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">
                {{ __('compt.mont') }} 
            </th>
            <th>
        ...
        <tbody class=" divide-y divide-gray-200 dark:divide-gray-600">
                ...
                @forelse ($depanses as $depanse)
                    <tr class="h-5 odd:bg-white even:bg-gray-50 dark:odd:bg-gray-800 dark:even:bg-gray-800/70">
                        ...
                        <td class="px-6 py-2">
                            <div dir="ltr" class="text-right w-full text-sm font-semibold text-gray-900 dark:text-gray-200">
                                {{   number_format($depanse->montant, 0, '.', ' ') }}
                            </div>
                        </td>
                       
                        <td class="flex space-x-2 py-2 h-full items-center">
                            <div class="mx-4">
                                <button wire:click="$dispatch('edit',{ ids: {{ $depanse->id }} })" >
                            ...
                            <div>
                                <button wire:click="$dispatch('dels',{ ids: {{ $depanse->id }} })" class=" stroke-red-600">
