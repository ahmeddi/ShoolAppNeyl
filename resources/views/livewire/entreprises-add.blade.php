<div  x-data="{telephone: '', telephone2: '', whatsapp: ''}">
            ...
            <div class="flex flex-col space-y-4 ">
                ...
                <div class="grid lg:grid-cols-2 gap-x-6 gap-y-3 px-12  justify-items-center sm:grid-cols-1 ">
                  ...
                  <div class="flex flex-col space-y-1">
                      ...
                      <input dir="ltr" lang="fr" x-model="whatsapp" x-mask="99 99 99 99" wire:model.defer='whatsapp' class="inputs @error('whatsapp') reds @enderror" type="text" required  />
                  </div>

                  <div class="flex flex-col space-y-1">
                    <div class="flex justify-between">
                      <label   class="labels">{{ __('ent.tel') }} 2:</label>
                      @error('telephone2') <span class="danger">{{ $message }}</span> @enderror  
                    </div>
                    <input dir="ltr" lang="fr" x-model="telephone2" x-mask="99 99 99 99" wire:model.defer='telephone2' class="inputs @error('telephone2') reds @enderror" type="text" required  />
                </div>
